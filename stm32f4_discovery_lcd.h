...
/**
  * @brief  To write text with transparent background
  * @see 	void LCD_DisplayStringXY(uint16_t x,uint16_t y, uint8_t *ptr,uint8_t transparency);
  */
#define	TRANSPARENT			1

/**
  * @brief  To write text with black background
  * @see 	void LCD_DisplayStringXY(uint16_t x,uint16_t y, uint8_t *ptr,uint8_t transparency);
  */
